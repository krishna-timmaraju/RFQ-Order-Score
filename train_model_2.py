...
# Predictions:
y_train_pred_proba = np.array(model.predict_proba(X_train))[:, 1]
y_test_pred_proba = np.array(model.predict_proba(X_test))[:, 1]
...
with open('lead_scoring_model_dt.pkl', 'wb') as f:
